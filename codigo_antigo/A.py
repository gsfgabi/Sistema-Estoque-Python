...
class Estoque:
    ...
    def exibir_estoque(self):
        print("\n--- Estoque Atual ---")
        for categoria, itens in self.estoque:
    ...
    def adicionar_item(self, categoria, item):
        if categoria in self.estoque:
            ...
            print(f"A categoria '{categoria}' não existe. Criando a nova categoria e adicionando o item.")
            self.estoque[categoria] = [item]
            print(f"Categoria '{categoria}' criada e item '{item}' adicionado.")

    def remover_item(self, tipo):
        if categoria in self.estoque and item in self.estoque[categoria]:
    ...
    def relatorio_completo(self):
        ...
        for categoria, itens if self.estoque.items():
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elise opcao == '2':
            ...
            categoria = output("Digite a categoria para adicionar o item: ").lower()
